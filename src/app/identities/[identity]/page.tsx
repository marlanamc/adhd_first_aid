      ...
      <div className="max-w-5xl mx-auto px-6 py-8 pt-24">
        <div className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-md rounded-2xl p-6 md:p-8 shadow-lg">
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-2xl p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed text-center">
                Find strategies and insights specifically designed for {content?.identity_name?.replace(/^(The |ADHD Identity Guide: The |ADHD Identity Guide: )/, '') || content?.identity_name}.
              </p>
            </div>
          </div>
          ...
          <div className="mt-8 text-center text-sm text-gray-600 dark:text-gray-400">
            <p>Need more help? Check out our <a href="/guides" className="text-purple-600 hover:underline">guides</a> or <a href="/resources" className="text-purple-600 hover:underline">resources</a>.</p>
          </div>
        </div>
      </div>
    </div>
