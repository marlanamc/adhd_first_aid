      ...
      <div className="text-center max-w-2xl mx-auto">
        ...
        <div className="mb-8 space-y-4">
          ...
          <p className="text-lg md:text-xl text-muted-foreground leading-relaxed font-light">
            ...
            Use the links below or go back to get back on track.
          </p>
        </div>

        {/* ADHD-Friendly Message */}
        <div className="mb-8 p-6 bg-white/70 backdrop-blur-sm border border-white/20 rounded-lg">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          <Button
            ...
            className="inline-flex items-center space-x-2 px-6 py-3 bg-primary hover:bg-primary/90 text-white rounded-full transition-all duration-200 font-medium"
          >
          ...
          <Button
            onClick={goBack}
            variant="outline"
            className="inline-flex items-center space-x-2 px-6 py-3 bg-white/60 hover:bg-white/80 text-foreground rounded-full transition-all duration-200 font-medium border border-white/20"
          >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl mx-auto">
          {[
            ...
            <button
              ...
              className="p-4 bg-white/60 backdrop-blur-sm border border-white/20 rounded-lg hover:bg-white/80 transition-all duration-200 text-center"
            >
