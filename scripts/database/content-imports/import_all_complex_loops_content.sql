-- Import all complex loops content to complex_loops_content table
...
\i scripts/database/content-schemas/complex_loops_content_schema.sql
...
-- Check specific loop content structure:
-- SELECT loop_name, content_sections FROM complex_loops_content WHERE loop_name = 'Analysis Paralysis';