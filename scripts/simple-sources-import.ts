...
async function importSources() {
  try {
    ...
    console.log(`Found ${existingData?.length || 0} existing sources`)
    ...
    console.log(`✅ Successfully imported ${insertedCount} sources!`)
    ...
    if (error.code === '42P01') {
      console.error('❌ Table "feeling_sources" does not exist.')
